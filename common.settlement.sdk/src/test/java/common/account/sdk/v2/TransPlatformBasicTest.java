 ...
 */
@Slf4j
public class TransPlatformBasicTest {
...
//		req.setUserOid("3c97543b24d945c29b97f72861e6fca5");
		...
		req.setOrigOrderNo("");
		req.setInputAccountNo("ANPLATFORM00000012"); //入-指定的平台备付金账户
		List<TradeEvent> eventList = new ArrayList<TradeEvent>();
		TradeEvent tradeEvent = new TradeEvent();
		tradeEvent.setBalance(new BigDecimal(10));
		tradeEvent.setEventType(EventTypeEnum.TRANSFER_PLATFORM_BASIC.getCode());
		eventList.add(tradeEvent);
		req.setEventList(eventList);
		log.info(System.currentTimeMillis()+"");
		AccountTransResponse resp = sdk.transferPlatformBasic(req);
		log.info(System.currentTimeMillis()+"");
