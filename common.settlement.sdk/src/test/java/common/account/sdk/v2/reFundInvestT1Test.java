...
@Slf4j
public class reFundInvestT1Test {
	...
	public static void main(String[] args) {
		...
		tradeEvent.setEventType(EventTypeEnum.REFUND_INVEST_T1.getCode());
		eventList.add(tradeEvent);
		TradeEvent tradeEvent2 = new TradeEvent();
		tradeEvent2.setBalance(new BigDecimal(1));
		tradeEvent2.setEventType(EventTypeEnum.REFUND_USE_VOUCHER_T1.getCode());
		eventList.add(tradeEvent2);
		req.setEventList(eventList);
		req.setOrigOrderNo("11111111111");
