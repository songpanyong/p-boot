...
public class RedeemT1Test {
	...
	public static void main(String[] args) {
		...
		req.setRemark("赎回");
		req.setOrderType(OrderTypeEnum.REDEEM_T1.getCode());
		...
		tradeEvent.setEventType(EventTypeEnum.REDEEM_T1.getCode());
		...
		AccountTransResponse resp = sdk.redeemT1(req);
