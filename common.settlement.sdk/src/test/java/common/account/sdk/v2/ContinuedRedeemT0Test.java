 ...
 */
@Slf4j
public class ContinuedRedeemT0Test {
	...
	public static void main(String[] args) {
		...
		tradeEvent.setEventType(EventTypeEnum.REDEEM_T0_CONTINUED.getCode());
		eventList.add(tradeEvent);
		req.setEventList(eventList);
		log.info(System.currentTimeMillis()+"");
		AccountTransResponse resp = sdk.redeemT0Continued(req);
		log.info(System.currentTimeMillis()+"");
		log.info("续投-实时兑付返回：{}",JSONObject.toJSONString(resp));
