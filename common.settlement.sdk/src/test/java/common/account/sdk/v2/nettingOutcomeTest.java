 ...
 */
@Slf4j
public class nettingOutcomeTest {
	...
	public static void main(String[] args) {
		...
		req.setOrderType("nettingOutcome");
		...
		tradeEvent.setEventType(EventTypeEnum.NETTING_OUTCOME.getCode());
		eventList.add(tradeEvent);
		req.setEventList(eventList);
		log.info(System.currentTimeMillis()+"");
		AccountTransResponse resp = sdk.nettingOutcome(req);
		log.info(System.currentTimeMillis()+"");
		log.info("轧差-出款 tradeEvent {}：{}",req.getRemark(),JSONObject.toJSONString(resp));
	}
