...
import com.guohuai.payadapter.bankutil.BankUtilReq;
import com.guohuai.payadapter.bankutil.BankUtilService;
import com.guohuai.payadapter.component.BankUtil;

@RunWith(SpringRunner.class)
@SpringBootTest
public class BankUtilTests {
	
	@Autowired
	BankUtilService bankUtilService;

	@Test
	public void bankBinLoads() {
		
		String idCard = "6212261001035245343";
		String cardName = bankUtilService.getNameByCard(idCard);
...
//		};
//		
//		BankUtilReq req = new BankUtilReq();
//		System.out.println(bankBin.length+"="+bankName.length);
//		for(int i = 0; i < bankBin.length; i++){
//			req.setBankBin(bankBin[i]);
//			String name = bankName[i].substring(0, bankName[i].lastIndexOf("·"));
//			req.setBankName(name);
//			req.setKindOfCard(bankName[i]);
//			bankUtilService.add(req);
//		}
	}
