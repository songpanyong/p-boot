...
@Configuration
@Transactional
public class RedeemService implements SceneAction {
	@Autowired
	...
	public void execute(BaseEvent baseEvent) {
		...
		log.info("==========={}", biz);
		this.onRedeemAsynch(biz);
		log.info("======模拟facadeService.onRedeem()去下发卡券=====");
	}
	...
	public void onRedeemAsynch(String biz) {
		...
		entity.setOrderType(EventConstants.EVENTTYPE_REDEEM);
